...
var require_utils = __commonJS({
  "node_modules/tiny-slider-react/build/utils.js"(exports) {
    "use strict";
    ...
    var ObjectsEqual = function ObjectsEqual2(val1, val2) {
    ...
    var ChildrenEqual = function ChildrenEqual2(val1, val2) {
...
var require_Carousel = __commonJS({
  "node_modules/tiny-slider-react/build/Carousel.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var _tinySlider = require_tiny_slider();
    ...
    var Carousel = function(_PureComponent) {
      _inherits(Carousel2, _PureComponent);
      ...
      _createClass(Carousel2, [{
        ...
        value: function onClick(event) {
          var onClick2 = this.props.onClick;
          if (this.dragging || !onClick2)
            return;
          if (!this.slider)
            return onClick2(null, null, event);
          var info = this.slider.getInfo();
          var slideClicked = info.slideItems[info.index];
          onClick2(slideClicked, info, event);
        }
        ...
        value: function build() {
          ...
          if (this.slider)
            return;
          if (this.hasForwardedRef && this.ref.current)
            this.ref.current.className += " tns-item";
          if (!this.hasForwardedRef && this.ref)
        ...
        value: function postInit() {
          ...
          var _this$props = this.props, onIndexChanged = _this$props.onIndexChanged, onTransitionStart = _this$props.onTransitionStart, onTransitionEnd = _this$props.onTransitionEnd, onTouchStart = _this$props.onTouchStart, onTouchMove = _this$props.onTouchMove, onTouchEnd = _this$props.onTouchEnd, onInit = _this$props.onInit;
          if (events) {
            ...
            if (onIndexChanged)
              events.on("indexChanged", onIndexChanged);
            if (onTouchStart)
              events.on("touchStart", onTouchStart);
            if (onTouchMove)
              events.on("touchMove", onTouchMove);
            if (onTouchEnd)
        ...
        value: function render() {
          var _this4 = this;
          var _this$props2 = this.props, children = _this$props2.children, className = _this$props2.className, style = _this$props2.style, forwardedRef = _this$props2.forwardedRef;
...
var require_build = __commonJS({
  "node_modules/tiny-slider-react/build/index.js"(exports) {
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    exports["default"] = void 0;
...
object-assign/index.js:
  ...
  *)
*/
//# sourceMappingURL=tiny-slider-react.js.map
